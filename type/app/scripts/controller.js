...
SimController.prototype.setupDisplay = function() {
    ...
    this.simModel.questionBank.createNewQuestions(this.simModel.datatype)
    ...
    this.simModel.questionBank.setAnswers(this.simModel.datatype);
    //console.log(this.simModel.questionBankView)
   // this.simView.questionBankView.drawAnswers(this.simModel.questionBank)
