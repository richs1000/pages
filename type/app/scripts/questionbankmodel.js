...
QuestionBankModel.prototype.createNewQuestions = function(_datatype) {
	...
	console.log(number)
	pizza = "Pizza"
	options = [8, string, x + y]
	selectedNumber = getRandomInt(0,3);
	if(selectedNumber  == 2){
		selected = "TwoInts(" + x + ", " + y + ")"
 		answer = x + y
	}else if (selectedNumber == 1){
		selected = "Str \"" + string + "\""
	}else if (selectedNumber == 0)
		selected = answer = pizza

    this.questions = [["datatype mytype = <br/> ",
    					"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   TwoInts of int * int <br/>",
    					"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Str of string <br/> " ,
    					"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Pizza  <br/><br/>", 
    					"fun f x = <br/>",
    					"&nbsp;&nbsp;&nbsp;&nbsp;case x of <br/>",
    					...
    					"<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;| Str s => s" ,
    					"<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|  TwoInts(x,y) => x + y",
    					"<br/><br/> val my = ", selected, ";" ,
    					"<br/><br/> What is the result of evaluation this ML expression: <br/>&nbsp;&nbsp;&nbsp; val a = f my;", options, selectedNumber]];
...
QuestionBankModel.prototype.setAnswers = function(_datatype) {
	...
	this.answers.push(options[selectedNumber])
}
